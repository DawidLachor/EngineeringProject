...
import pl.skorpjdk.engineeringproject.account.UserRole;
import pl.skorpjdk.engineeringproject.email.EmailSender;
import pl.skorpjdk.engineeringproject.email.EmailValidator;
...
public class RegistrationService {
    ...
    private boolean checkUsername(RegistrationRequest request) {
        try {
            accountService.findByUsername(request.getUsername());
        } catch(Exception e){
            return false;
        }
        return true;
